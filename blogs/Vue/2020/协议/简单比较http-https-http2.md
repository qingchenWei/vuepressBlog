...
:::tip Abstract
1. 超文本传输​​协议（HTTP）
2. HTTP Strict Transport Security (通常简称为HSTS) 是一个安全功能，它告诉浏览器只能通过HTTPS访问当前资源, 禁止HTTP方式.
3. SPDY
4. 二进制、复用、压缩、服务端推送
:::
...
开启HSTS只需要当通过HTTPS方式访问你的网站时，返回 Strict-Transport-SecurityHTTP 头信息: Strict-Transport-Security: max-age=expireTime [; includeSubdomains]
...
![w8wU00.png](https://s1.ax1x.com/2020/09/09/w8wU00.png)
...
![w8wNmq.png](https://s1.ax1x.com/2020/09/09/w8wNmq.png)
...
![w8wa7V.png](https://s1.ax1x.com/2020/09/09/w8wa7V.png)
